...
from .forms import LoginForm,RegistrationForms,UserProfileForm
...
def register(request):
    if request.method == 'POST':
        ...
        userfrofile_form = UserProfileForm()
        return render(request,'account/register.html',{'form':user_form,'profile':userfrofile_form})
def hello(request):
